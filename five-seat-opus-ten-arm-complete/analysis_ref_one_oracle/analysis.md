...
## Paired effects vs `one_oracle`

| arm | normalized_primary | normalized_nash_welfare | deal_rate | gini | worst_off | max_share |
|---|---|---|---|---|---|---|
| `all_fairness_algorithmic` | -0.183 | -0.088 | -0.133 | -0.011 | -0.025 | 0.021 |
| `all_fairness_oracle` | 0.506 | 0.356 | 0.492 | -0.097 | 0.167 | -0.039 |
| `all_llm` | 0.412 | 0.273 | 0.450 | -0.040 | 0.070 | -0.018 |
| `all_oracle` | 0.330 | 0.130 | 0.367 | -0.003 | -0.016 | -0.002 |
| `all_rational` | -0.272 | -0.145 | -0.275 | -0.028 | -0.011 | -0.021 |
| `all_selfish_dp_oracle` | 0.411 | 0.157 | 0.492 | -0.009 | -0.005 | 0.013 |
| `one_fairness_algorithmic` | 0.237 | 0.169 | 0.300 | -0.036 | 0.052 | -0.009 |
| `one_fairness_oracle` | 0.389 | 0.252 | 0.425 | -0.048 | 0.082 | -0.022 |
| `one_rational` | 0.226 | 0.148 | 0.258 | -0.040 | 0.050 | -0.023 |
